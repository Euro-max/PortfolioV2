...
axios.get(url).then((response)=>{SetData(response.data)
  ...
  return (
    <section className=' text-white pt-[50px] bg-[#222222] mt-[-20px]' id='Bio'>
